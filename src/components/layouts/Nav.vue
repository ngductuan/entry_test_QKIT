<template>
  <div
    class="nav-sec scroll-bar-custom-2"
    :class="{ 'nav-change-sec': navBool }"
  >
    <!-- Home -->
    <div class="tab-sec" :class="{ 'tab-sec-change': navBool }">
      <a
        class="tab-card active-tab"
        :class="{ 'nav-change-state': navBool }"
        href="/"
      >
    ...
    <div class="tab-sec" :class="{ 'd-none': navBool }" style="padding: 0px">
      ...
      <div class="footer-nav" style="padding: 12px 24px 0">
        <a href="https://www.youtube.com/about/">Terms</a>
        <a href="https://www.youtube.com/about/press/">Privacy</a>
        <a href="https://www.youtube.com/about/copyright/">Policy & Safety</a>
        <a href="/t/contact_us/">How Youtube works</a>
